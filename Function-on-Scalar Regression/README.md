...
This directory contains the dataset and R implementation for the neural netowrk-based function-on-scalar (FoS) regression model, termed NNBR, introduced in the manuscript "[Neural Networks for Scalar Input and Functional Output](https://doi.org/10.1007/s11222-023-10287-3)". For implementation of all neural network-based FoS models developed, including NNBB, NNSS, NNBR & NNSR, please refer to the complete code repository: [Neural network-based FpS Github Repository](https://github.com/sidiwu/NN_SIFO).
